...
CONFIGS: Dict[str, ServerConfig] = {
    "hermes": {
        "model": "solidrust/Hermes-2-Pro-Llama-3-8B-AWQ",
        "arguments": [
            "--tool-call-parser",
            "hermes",
            "--chat-template",
    ...
    #        "llama3.1",
    #        "--chat-template",
    #        str(VLLM_PATH / "examples/tool_chat_template_llama3.1.jinja"),
    #    ],
    # }
}
...
MESSAGES_WITHOUT_TOOLS: List[ChatCompletionMessageParam] = [
    {
        "role": "system",
        "content": "You are a helpful assistant with access to tools. If a tool"
